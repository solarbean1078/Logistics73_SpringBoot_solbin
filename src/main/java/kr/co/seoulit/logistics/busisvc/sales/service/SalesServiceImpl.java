...
public class SalesServiceImpl implements SalesService {
    ...
    @Override
    public ArrayList<QuarterTO> getSalesChart() {

        ArrayList<QuarterTO> salesChart = null;

        salesChart = deliveryMapper.selectSalesChart();
    ...
    @Override
    public void deleteCustomerReport() {

        deliveryMapper.deleteCustomerList();
    ...
    @Override
    public ArrayList<ReturnInfoTO> getReturnInfoList(String startDate,String endDate) {
        ArrayList<ReturnInfoTO> returnInfoList = null;

        returnInfoList = deliveryMapper.selectReturnInfoList(startDate,endDate);
